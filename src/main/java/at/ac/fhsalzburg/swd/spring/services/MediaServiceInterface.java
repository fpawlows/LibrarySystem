...
public interface MediaServiceInterface {
    ...
    public abstract boolean addAudio(Integer duration, String codec, String name, String description, Integer fsk, Date datePublished, List<Genre> genres, Collection<Copy> copies, List<Reservation> reservations);
    ...
    public abstract Collection<Media> getAllMedia();
